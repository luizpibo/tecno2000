...
const NavBar = () => {
  ...
  return (
    <nav className="flex flex-wrap items-center justify-between py-3 2xl:py-8 text-slate-700 w-full z-50 fixed overflow-hidden shadow-xl rounded-b-xl backdrop-blur-sm bg-opacity-90 bg-gray-300">
